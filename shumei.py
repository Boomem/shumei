...
class Sm(object):
    def __init__(self):
        self.info_url = "https://captcha.fengkongcloud.com/ca/v1/register?organization=RlokQwRlVjUrTUlkIqOg&appId=default&channel=DEFAULT&lang=zh-cn&model=slide&rversion=1.0.1&sdkver=1.0.0&data=%7B%7D&callback=sm_{}".format(str(int(time.time()*1000)))
    ...
    def get_cap_info(self):
        ...
        # return {
        #     "detail": {
        #         "bg": "/crb/set-000008-1.0.1-r1/v2/a10be5b633ada3cb7947bf79650064fe_bg.jpg",
        #         "fg": "/crb/set-000008-1.0.1-r1/v2/57977d6664804eb82fb5295ac298322d_fg.png",
        #         "k": "O8GKzP6G5xE=",
        #         "rid": "20190524154745cd5e78949b69dcf105"
        #     }
        # }
